...
local KINDS = {
	...
	-- Raid shop gear (RunBuffService.TickGear's sourceTag). Smaller than gunfire: it ticks constantly,
	-- and a crowd under the aura should read as a background hum, not drown out your own shots.
	ScorchAura  = { Color = Color3.fromRGB(255, 110, 40),  Size = 15 },
	OrbitBlades = { Color = Color3.fromRGB(200, 205, 215), Size = 15 },
	LaserDrone  = { Color = Color3.fromRGB(90, 210, 255),  Size = 16 },
